 ...
 * 
 */
public final class CheckSudokuTest extends TestCase {

  private static final Logger LOG = Logger.getLogger(CheckSudokuTest.class);
  ...
  public void testCheck() {
    List<SudokuData> sudokuDatas = sudokuDao.findSudokus(SudokuSize.NEUN, Level.SEHR_SCHWER, 100, Boolean.FALSE);
    for (SudokuData sudokuData : sudokuDatas) {
