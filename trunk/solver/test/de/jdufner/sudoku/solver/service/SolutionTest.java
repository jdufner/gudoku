...
public class SolutionTest extends AbstractSolverTestCase {
  ...
  public void testToString() {
    ...
    assertTrue(solutionString.contains("Quest"));
    assertTrue(solutionString.contains("Result"));
    assertTrue(solutionString.contains("Unique"));
    assertTrue(solutionString.contains("Level"));
  }
}
